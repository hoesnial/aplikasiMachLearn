...
def show():
    ...
    Halaman ini akan digunakan untuk memprediksi kebutuhan treatment pasien
    berdasarkan dataset yang akan ditambahkan oleh anggota kelompok.

    ### 🎯 Rencana Implementasi
    - **Dataset**: Pasien Treatment (akan diupload)
    - **Target**: Prediksi apakah pasien membutuhkan treatment tertentu
