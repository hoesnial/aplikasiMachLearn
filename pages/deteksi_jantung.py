"""
Halaman Deteksi Penyakit Jantung
...
def show():
    st.markdown("# ❤️ Deteksi Penyakit Jantung")
    st.markdown("---")
    ...
    Halaman ini akan digunakan untuk memprediksi risiko penyakit jantung
    berdasarkan dataset yang akan ditambahkan oleh anggota kelompok.

    ### 🎯 Rencana Implementasi
    - **Dataset**: Heart Disease (akan diupload)
    - **Target**: Prediksi apakah pasien berisiko penyakit jantung
